...
function AboutMe() {
  ...
  <p>I have mastered <span className="tech">Javascript</span>, <span className="tech">NodeJS</span>, <span className="tech">Typescript</span>,<span className="tech">NextJS</span> technologies. My familiarity with databases like <span className="db">MySQL</span>, <span className="db">PostgreSQL</span>, <span className="db">MongoDB</span> adds depth to my skill set. 📚</p>
